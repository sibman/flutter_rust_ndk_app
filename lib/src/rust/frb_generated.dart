...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 958064036;
...
abstract class RustLibApi extends BaseApi {
  Priority crateApiModelPriorityFromString(
      {required String value, dynamic hint});

  Priority crateApiModelPriorityHighPriority({dynamic hint});

  Priority crateApiModelPriorityLowPriority({dynamic hint});

  Priority crateApiModelPriorityNormalPriority({dynamic hint});

  String crateApiModelPriorityToString({required Priority that, dynamic hint});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Priority crateApiModelPriorityFromString(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiModelPriorityFromStringConstMeta,
      argValues: [value],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiModelPriorityFromStringConstMeta =>
      const TaskConstMeta(
        debugName: "Priority_from_string",
        argNames: ["value"],
      );
  ...
  Priority crateApiModelPriorityHighPriority({dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiModelPriorityHighPriorityConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiModelPriorityHighPriorityConstMeta =>
      const TaskConstMeta(
        debugName: "Priority_high_priority",
        argNames: [],
      );
  ...
  Priority crateApiModelPriorityLowPriority({dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiModelPriorityLowPriorityConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiModelPriorityLowPriorityConstMeta =>
      const TaskConstMeta(
        debugName: "Priority_low_priority",
        argNames: [],
      );
  ...
  Priority crateApiModelPriorityNormalPriority({dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiModelPriorityNormalPriorityConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiModelPriorityNormalPriorityConstMeta =>
      const TaskConstMeta(
        debugName: "Priority_normal_priority",
        argNames: [],
      );
  ...
  String crateApiModelPriorityToString({required Priority that, dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiModelPriorityToStringConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiModelPriorityToStringConstMeta =>
      const TaskConstMeta(
        debugName: "Priority_to_string",
        argNames: ["that"],
      );
  ...
  void crateApiSimpleDeleteTasks({dynamic hint}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleDeleteTasksConstMeta,
      argValues: [],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kCrateApiSimpleDeleteTasksConstMeta => const TaskConstMeta(
        debugName: "delete_tasks",
        argNames: [],
      );
  ...
  List<Task> crateApiSimpleReadAllTasks(
    ...
    return handler.executeSync(SyncTask(
      callFfi: () {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_Chrono_Local(createdAt, serializer);
        sse_encode_bool(isCompletedOnly, serializer);
        sse_encode_bool(isIgnoreCreatedAt, serializer);
      ...
      argValues: [createdAt, isCompletedOnly, isIgnoreCreatedAt],
      apiImpl: this,
      hint: hint,
    ));
  }
  ...
  TaskConstMeta get kCrateApiSimpleReadAllTasksConstMeta => const TaskConstMeta(
        ...
        argNames: ["createdAt", "isCompletedOnly", "isIgnoreCreatedAt"],
      );
